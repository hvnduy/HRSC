/*
 * $Id: EstoreInventoryModel.java,v 1 2015/01/13 13:58:00 Exp $
 *
 ...
 * @author khoapkl
 */
public class EstoreInventoryModel implements Serializable {
	...
	/**
	 * @return the daysAtMri
	 */
	public int getDaysAtMri() {
		return this.daysAtMri;
	}
	...
	/**
	 * @param daysAtMri
	 *            the daysAtMri to set
	 */
	public void setDaysAtMri(int daysAtMri) {
		this.daysAtMri = daysAtMri;
	}
	 ...
	 */
	public void setDownloadFilenName(String downloadFileName) {
