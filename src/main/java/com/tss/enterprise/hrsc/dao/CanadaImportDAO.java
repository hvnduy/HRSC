/*
 * $Id: CanadaImportDAO.java,v 1 2015/01/23 13:58:00  Exp $
 *
...
/**
 * The Interface CanadaImportDAO.
 * @author duyhuynh
 */
public interface CanadaImportDAO {
	 ...
	 * @return the int
	 */
	int updateContactBatch(List<ContactInfoModel> contactInfoModelList);
}
